...
**（3）【EP03_安装部署】零基础上手 OpenClaw 实战：从零打造智能体驱动的商业自动化闭环。OpenClaw安装、验证、升级与卸载并测试基本功能正常运营。**    
- YouTube频道对应视频: [https://youtu.be/skkUTEZHR4Q](https://youtu.be/skkUTEZHR4Q)         
...
**（6）【EP06_资讯简报助手】零基础上手 OpenClaw 实战：从零打造智能体驱动的商业自动化闭环。为你省下第一波时间场景应用：即时/定时检索并推送简报。**    
- YouTube频道对应视频: [https://youtu.be/tOIz0Ou47Ds](https://youtu.be/tOIz0Ou47Ds)         
...
- B站频道对应视频: [https://www.bilibili.com/video/BV11hdZBkEFc/](https://www.bilibili.com/video/BV11hdZBkEFc/)           
- 资料在 08_*** 文件夹，下载即可
